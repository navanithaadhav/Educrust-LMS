        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 my-16 px-2 md:p-0'>
          {filteredCourses.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20">
              <img src={assets.search_icon} alt="No results" className="mx-auto w-16 opacity-20 mb-4 grayscale" />
              <h2 className="text-2xl font-medium text-gray-400">No courses found for "{input}"</h2>
              <p className="text-gray-400 mt-2">Try searching for something else or browse all courses.</p>
              <button
