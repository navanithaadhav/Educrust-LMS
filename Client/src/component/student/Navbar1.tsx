    ...
    <nav className="sticky top-0 left-0 w-full z-50 bg-blue-900 text-white px-4 sm:px-10 py-3">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-6 items-center">
          ...
          <ScrollLink to="about" smooth duration={500} offset={-70} className="cursor-pointer hover:text-yellow-400">About</ScrollLink>
          <div onClick={() => navigate('/course-list')} className="cursor-pointer hover:text-yellow-400">Course</div>
          <ScrollLink to="contact" smooth duration={500} offset={-70} className="cursor-pointer hover:text-yellow-400">Contact</ScrollLink>
          <div onClick={() => navigate('/my-enrollments')} className="cursor-pointer hover:text-yellow-400">My Enrollments</div>
          <div onClick={() => navigate('/educator')} className="cursor-pointer hover:text-yellow-400">Educator Dashboard</div>
