...
const Footer = () => {
  return (
   ...
   <div className="max-w-5xl mx-auto  rounded-lg shadow-lg px-15 py-8 flex justify-between items-center -mt-30 mb-12 relative z-20 bg-[url('/footer.png')] bg-cover bg-center bg-opacity-70">
       <div>
        <p className="text-lg md:text-xl text-white font-medium mb-2">
          Couldn't find what you looking?
        </p>
        <h2 className="text-3xl md:text-4xl font-bold text-gray-200 mb-6 text-center">
          Connect with <span className='text-black'>us</span> Right Away.
        </h2>
        </div>
        <div>
