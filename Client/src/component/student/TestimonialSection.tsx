...
const TestimonialSection = () => {
    const { testimonial } = useAppContext()
    return (
        <div className='py-8 md:px-8 lg:px-14 px-8 flex flex-col justify-center items-center mb-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 md:px-0  md:my-16 my-10 gap-8 mt-14'>
